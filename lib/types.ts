...
export type DashboardData = { me: Member; members: Member[]; assignments: Assignment[]; submissions: Submission[]; settings: Settings; today: string; demo?: boolean; health?: { last_run: string | null; last_error: string | null; sent: number; pending: number } };
